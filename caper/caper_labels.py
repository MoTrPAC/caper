"""Manage Cromwell workflow labels for tracking and querying."""
...
class CaperLabels:
    ...
    def create_file(
        ...
        if str_label:
            new_str_label = re.sub(RE_ILLEGAL_STR_LABEL_CHRS, SUB_ILLEGAL_STR_LABEL_CHRS, str_label)
